                                            ...
                                            <div class="section-header ">
                                                <div class="header-left">
                                                    <div class="card-inner__end card-inner__start">
                                                        <a href="{{route('create-meeting-package')}}" class="btn btn__theme  btn__add">
                                                                                        ...
                                                                                        <td>
                                                                                            <div class="dropdown show">
                                                                                                ...
                                                                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                                                                    <a class="dropdown-item" href="{{route('edit-meeting-package',['id'=> $package->meeting_packages_id,'action'=>'edit'])}}">Edit</a>
                                                                                                    <a class="dropdown-item" href="{{route('edit-meeting-package',['id'=> $package->meeting_packages_id,'action'=>'view'])}}">View</a>
                                                                                                    <a class="dropdown-item del-record"
                                                                                                       data-url="{{route('delete-meeting-package',['id'=>$package->meeting_packages_id])}}">Delete</a>
                                                                                                </div>
                                                                                            </div>
                                                                                        </td>
                                                                                    </tr>
