                                        ...
                                        <div class="col-12 col-lg-12 px-0">
                                            ...
                                            <div class="section-content inline-content ">
                                                <div id="tab-1" class="theme-tab-content current create-protocol">
                                                    ...
                                                    <div class="form-container">
                                                        <label>Price</label>
                                                        <input type="text" class="text-editor form-control  @error('price') is-invalid @enderror" value="{{old('price')}}" name="price" placeholder="Write your package amount  here" rows="10">
                                                        @error('price')
                                                        <span class="invalid-feedback" role="alert">
                                                                <strong>{{ $message }}</strong>
                                                            </span>
