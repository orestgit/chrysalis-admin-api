                                    ...
                                    <div class="section-header ">
                                        <div class="header-left">
                                            <div class="card-inner__end card-inner__start">
                                                <a href="{{route('create-course-banners')}}" class="btn btn__theme  btn__add">
                                                                                ...
                                                                                <td class="w-25">
                                                                                    <div class="dropdown show">
                                                                                        ...
                                                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                                                             <a class="dropdown-item" href="{{route('get-course-advertisement',['id'=>$type->course_advertisements_id ])}}">Edit</a>
                                                                                             <a class="dropdown-item del-record"
                                                                                                data-url="{{route('delete-course-advertisement',['id'=>$type->course_advertisements_id])}}">Delete</a>
                                                                                         </div>
                                                                                    </div>
