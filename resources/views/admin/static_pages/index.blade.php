                                            ...
                                            <section>
                                                <div class="section-content inline-content">
                                                    <div id="tab-1" class="theme-tab-content current">
                                                        <form method="post" action="{{route('save-static-pages')}}" enctype="multipart/form-data">
                                                            @csrf
                                                            <div class="container-fluid">
                                                                <div class="row">
                                                                    <div class="col-12 col-xl-8 col-lg-12">
                                                                        <div class="text-editor-continer px-0">
                                                                            <textarea class="text-editor form-control @error('content') is-invalid @enderror" name="content" placeholder="Write your post text here" >{{old('content')}}</textarea>
                                                                            @error('content')
                                                                        ...
                                                                        <section>
                                                                            <div class="form-container p-0">
                                                                                    ...
                                                                                    <div class="form-group form-input-container">
                                                                                        <label for="">Page
                                                                                            Title</label>
                                                                                        <input type="text"  value="{{old('title')}}"  class="form-control input__theme @error('title') is-invalid @enderror" name="title" value="" id="" aria-describedby="helpId" placeholder="Type Title">
                                                                                        @error('title')
                                                                                        <span class="invalid-feedback" role="alert">
                                                                                            <strong>{{ $message }}</strong>
                                                                                        </span>
                                                                                    ...
                                                                                    <div class="form-group form-input-container">
                                                                                        <label for="">Choose Parent
                                                                                            Page</label>
                                                                                        <select name="parent" id="" class="wide select">
                                                                                             <option value="0">None</option>
                                                                                             @foreach($pages as $page)
                                                                                                <option value="{{$page['page_id']}}"
                                                                                                    @if(old('parent')==$page['page_id']) selected @endif
                                                                                                >{{$page['title']}}</option>
                                                                                            @endforeach
                                                                                        </select>
                                                                                    </div>
                                                                                        ...
                                                                                        <label class="image-picker-label" for="imageUpload">
                                                                                            <div id="imagePreview"
                                                                                                ...
                                                                                                <div
                                                                                                    ...
                                                                                                    <input type='file' class="@error('icon') is-invalid @enderror"  id="imageUpload" accept=".png, .jpg, .jpeg"  name="icon"/>
                                                                                                    @error('icon')
                                                                                                    <span class="invalid-feedback" role="alert">
                                                                                                        <strong>{{ $message }}</strong>
                                                                                                    </span>
