...
@section('content')
    ...
    <!-- bottom main -->
        <form action="{{route('update-surgical-category')}}"  method="post" enctype="multipart/form-data">
            @csrf
                                                ...
                                                <div id="tab-1" class="theme-tab-content current create-protocol">
                                                    <div class="form-container ">
                                                        ...
                                                        <input type="text" class="form-control input__theme  @error('title') is-invalid @enderror"
                                                               value="{{$category['title']}}" name="title" id="" aria-describedby="helpId" placeholder="Type Title">
                                                        @error('title')
