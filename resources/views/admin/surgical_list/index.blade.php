                                        ...
                                        <div class="section-header ">
                                            <div class="header-left">
                                                <div class="card-inner__end card-inner__start">
                                                    <a href="{{ route('add-surgical-algorythm') }}"
                                                        class="btn btn__theme  btn__add">
                                            ...
                                            <div class="tab-content_data">
                                                <section class="section-space__top">
                                                    <div class="container-fluid">
                                                        <div class="row">
                                                            <div
                                                                class="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12 card">
                                                                <div class="card-container px-0 py-4">
                                                                    <div class="table-container">
                                                                        <div class="table-responsive">
                                                                            <table
                                                                                class="table tbody-tdetail  table-add-action "
                                                                                id="table-1">
                                                                                <thead>
                                                                                    <tr>
                                                                                        <th>Title</th>
                                                                                                ...
                                                                                                <div class="dropdown show">
                                                                                                    ...
                                                                                                    <div class="dropdown-menu"
                                                                                                        ...
                                                                                                        <a class="dropdown-item"
                                                                                                            href="{{ route('manage-surgical-screens', ['id' => $category->id, 'action' => 'view', 'step' => 1]) }}">View</a>
                                                                                                        <a class="dropdown-item"
                                                                                                            href="{{ route('manage-surgical-screens', ['id' => $category->id, 'action' => 'edit']) }}">Edit
                                                                                                            Algorithm Title</a>
                                                                                                        <a class="dropdown-item"
                                                                                                            href="{{ route('manage-surgical-screens', ['id' => $category->id, 'action' => 'screens', 'step' => 1]) }}">Edit Screens</a>
