...
<head>
    ...
    <!-- plugins end -->
    <!-- js -->
    <script src='https://maps.googleapis.com/maps/api/js?key=AIzaSyBxAx4g5NCIpyHIP6s_n20flYKX4Y1CWsk&amp;libraries=places'>
    </script>
...
<body>
        ...
        <div class="sidebar-container">
            <nav class="navbar navbar-expand navbar-light">
                ...
                <a class="navbar-brand w-100 text-center" href="{{ route('admin-dashboard') }}">
                    <img class="logo img-responsive" src="../../public/assets/images/logo.png" alt="chrysalis"
                        srcset="" />
                </a>
            </nav>
                                ...
                                <div class="side-menus-list">
                                    ...
                                    <ul id="accordion" class=" accordion">
                                        @if (Auth::user()->user_role == 1)
                                            <li
                                                class="sidebar-menu @if (Request::path() == 'admin/dashboard') admin-dashboard-active @endif">
                                        ...
                                        @if (Auth::user()->user_role == 1 || Auth::user()->user_role == 2)
                                            <li
                                                class="sidebar-menu @if (preg_match('#post#i', Request::path())) admin-dashboard-active @endif">
                                                <a class="link text-16 text-light-pink">
                                                    <span class="svg-block">
                                                        <svg class="svg-icon" viewBox="0 0 24 24" fill="none"
                                                            xmlns="http://www.w3.org/2000/svg">
                                                            ...
                                                            <mask id="path-2-inside-2" fill="white">
                                                                <rect x="0.000244141" y="18" width="24" height="6"
                                                                    rx="1" />
                                                            </mask>
                                                            <rect class="admin-icon-color" x="0.000244141" y="18"
                                                                width="24" height="6" rx="1" stroke="#B3B3B3"
                                                ...
                                                <ul class="submenu">
                                                    <li class="sub-menu-list"><a href="{{ route('list-posts') }}">All
                                                            Posts</a></li>
                                                    @if (Auth::user()->user_role == 1)
                                                        <li class="sub-menu-list"><a
                                                                href="{{ route('list-post-types') }}">Post Types</a>
                                                        </li>
                                                    @endif
                                            </li>
                                    ...
                                    <li
                                        class="sidebar-menu @if (preg_match('#course#i', Request::path())) admin-dashboard-active @endif">
                                        <a class="link text-16 text-light-pink">
                                            <span class="svg-block">
                                        ...
                                        <ul class="submenu">
                                            <li class="sub-menu-list"><a href="{{ route('list-courses') }}">All
                                                    Courses</a></li>
                                            @if (Auth::user()->user_role == 1)
                                                <li class="sub-menu-list"><a
                                                        href="{{ route('list-course-categories') }}">Course
                                                        Categories</a></li>
                                                <li class="sub-menu-list"><a
                                                        href="{{ route('course-banners') }}">Courses Banner</a></li>
                                            @endif
                                    </li>
                                    ...
                                    @if (Auth::user()->user_role == 1 || Auth::user()->user_role == 3)
                                        <li
                                            class="sidebar-menu @if (preg_match('#meetings#i', Request::path())) admin-dashboard-active @endif">
                                            <a class="link text-16 text-light-pink">
                                                <span class="svg-block">
                                                    <svg class="svg-icon" viewBox="0 0 26 24" fill="none">
                                                        <g class="admin-icon-color" opacity="0.3">
                                            ...
                                            <ul class="submenu">
                                                <li class="sub-menu-list"><a href="{{ route('allMeetingsList') }}">All
                                                        Meetings</a></li>
                                            ...
                                            <li class="sub-menu-list"><a href="{{ route('completed-meetings') }}">Completed  Banner</a></li> -->
                                                <li class="sub-menu-list"><a
                                                        href="{{ route('Meetings') }}">Meetings</a></li>
                                    ...
                                    @if (Auth::user()->user_role == 1)
                                        <li
                                            class="sidebar-menu @if (preg_match('#meeting-pa#i', Request::path())) admin-dashboard-active @endif">
                                            <a href="{{ route('list-meeting-packages') }}"
                                                class="link text-16 text-light-pink">
                                                <span class="svg-block">
                                                    <svg class="svg-icon" viewBox="0 0 26 24" fill="none">
                                                        <g class="admin-icon-color" opacity="0.3">
                                                            <path class="admin-icon-color"
                                        ...
                                        <li
                                            class="sidebar-menu @if (preg_match('#user#i', Request::path())) admin-dashboard-active @endif">
                                        ...
                                        <li class="sidebar-menu @if (preg_match('#protocol#i', Request::path())) admin-dashboard-active @endif">
                                                <a class="link text-16 text-light-pink">                                              
                                                <span class="svg-block">
                                                    <svg class="svg-icon" viewBox="0 0 26 24" fill="none">
                                                        <g class="admin-icon-color" opacity="0.3">
                                                ...
                                                </span> Protocol<span class="dropdown__arrow up">
                                                    <img src="{{ asset('assets/images/icons/arrow-down.svg') }}"
                                                        alt="">
                                                </span>
                                                </a>
                                                <ul class="submenu">
                                                    <li class="sub-menu-list"><a href="{{ route('list-protocols') }}">List
                                                            Protocols</a></li>
                                                    <li class="sub-menu-list"><a
                                                            href="{{ route('list-protocol-chapters') }}">Protocol Chapters</a></li>
                                                </ul>

                                            <!--
                                            <a href="{{ route('list-protocol-chapters') }}"
                                                class="link text-16 text-light-pink">
                                                <span class="svg-block">
                                                    <svg class="svg-icon" viewBox="0 0 26 24" fill="none">
                                                        <g class="admin-icon-color" opacity="0.3">
                                        ...
                                        <li
                                            class="sidebar-menu @if (in_array(Request::path(), ['admin/list-packages', 'admin/create-package'])) admin-dashboard-active @endif">
                                        ...
                                        <li
                                            class="sidebar-menu @if (preg_match('#surgic#i', Request::path())) admin-dashboard-active @endif">
                                            <a class="link text-16 text-light-pink">
                                                <span class="svg-block">
                                                    <svg class="svg-icon" viewBox="0 0 24 24" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <ul class="submenu">
                                                <li class="sub-menu-list"><a href="{{ route('surgical-list') }}">List
                                                        of Algorithms</a></li>
                                                <li class="sub-menu-list"><a
                                                        href="{{ route('add-surgical-algorythm') }}">Add New
                                                        Algorithm</a></li>
                                            </ul>
                                        </li>
                                        ...
                                        <li
                                            class="sidebar-menu @if (Request::path() == 'admin/list-static-pages') admin-dashboard-active @endif">
                                            <a href="{{ route('list-static-pages') }}"
                                                class="link text-16 text-light-pink">
                                                <span class="svg-block">
                                                    <svg class="svg-icon" viewBox="0 0 26 24" fill="none">
                                                        <g class="admin-icon-color" opacity="0.3">
                                    ...
                                    @endif
                                    <li
                                        class="sidebar-menu @if (Request::path() == 'admin/admin-settings') admin-dashboard-active @endif">
                                        <a href="{{ route('admin-settings') }}" class="link text-16 text-light-pink">
                                            <span class="svg-block">
                                                <svg class="svg-icon" viewBox="0 0 24 24" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <g class="admin-icon-color" opacity="0.3" clip-path="url(#clip0)">
                                                        <path class="admin-icon-color"
            ...
            <div class="modal-content modal-field">
                <div class="container-fluid">
                    ...
                    <div class="modal-footer">
                        ...
                        <a href="{{ route('admin-logout') }}" id="btn-green"
                            class="btn btn-theme-primary send-notification">YES</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).click(function(event) {
                if (!$(event.target).closest(".bell_notification_clicker ,.menu_notification_wrap")
                    .length) {
...
<div class="modal fade bd-example-modal-md" id="deleteModelCenter" tabindex="-1" role="dialog" aria-labelledby=""
    aria-hidden="true">
