...
<head>
    ...
    <title>Chrysalis Reset Password</title>
    <!-- font family -->
                    ...
                    <form action="{{route('post-reset-password') }}" method="POST">
                        ...
                        <div class="form-group form-input-container">
                            <label for="email_address" >E-Mail Address</label>
                                <input type="text" id="email_address" class="form-control input__theme" name="email" required autofocus>
                                @if ($errors->has('email'))
                        ...
                        <div class="form-group form-input-container">
                            <label for="password" >Password</label>
                                ...
                                <input type="password" id="password" class="form-control input__theme" name="password" required autofocus>
                        ...
                        <div class="form-group form-input-container">
                            <label for="password-confirm"  >Confirm Password</label>
                                ...
                                <input type="password" id="password-confirm" class="form-control input__theme" name="password_confirmation" required autofocus>
