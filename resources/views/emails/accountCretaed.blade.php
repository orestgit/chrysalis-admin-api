...
padding:35px 35px;">
  ...
  ">
    ...
    color: #848484;
    line-height: 1.2;
    letter-spacing: 0.03rem;">Your account has been creaetd with following details<br>
                                <b>Email : </b> {{$user_email}}<br/>
                                <b>Password : </b> {{$password}}<br/>
                                <b>Message from Admin : </b> {{$custom_message}}<br/>
                                We welome you on board .
                                </p>
                                <p>Please click <a href="{{route('admin-login')}}"> here</a> to login to your account </p>
                        </div>
    ...
    border-bottom-right-radius: 10px;
          background: #795BF1;">
             ...
             padding: 15px 0px;
             /* margin-top: 8px; */
             margin: 0;">© 2022 Chrysalis All Rights Reserved</p>
                            </div>
                        </div>
