...
use App\Http\Controllers\admin\AdminSurgicalEditController;
...
Route::group(['prefix' => 'admin', 'middleware' => ['customAuth']], function () {
    ...
    Route::post("manage-surgical-screens", [AdminSurgicalEditController::class, 'updateTitle'])->name('update-title');
    Route::post("edit-surgical-screens", [AdminSurgicalEditController::class, 'updateScreen'])->name('update-screen');
    ...
    Route::post("surgical-protocol-question-option", [AdminSurgicalQuestionController::class, 'updatequestionOptions'])->name('surgical-protocol-question-option');
    /** Surgical section */
});
